...
const FacilitiesTable = () => {
    ...
    return (
        <div className="flex flex-col mt-6">
                    ...
                    <div className="overflow-hidden border border-primary/80 dark:border-gray-700 md:rounded-lg">
                        <table className="min-w-full divide-y divide-primary">
                            ...
                            <tbody className="bg-secondary divide-y divide-primary">
                                {facilities?.data?.filter((facility: TFacility) => facility?.isDeleted === false)?.map((facility: TFacility) => (
                                    <tr key={facility._id}>
            ...
            {/* Show Modal */}
            {openModal && (
                <Modal setOpenModal={setOpenModal} facilityIdForModal={facilityIdForModal} />
            )}
        </div>
    )
}
